...
const ZAC_ZOOM = "https://us02web.zoom.us/j/86209979595?pwd=zbLnB1OvbUccvP5HeKvgU1YJNfYebj.1";
...
const mathCourses = [
    ...
    new Course(Tiers.I, Subjects.M, "#02", "Tuesday", "10:30-11:15", IM_Folder, CORBIN_ZOOM, `${IM_Overview}${NOTE_START}No classes week of 6/1${NOTE_END}`, "img/erinm.webp", "Erin Moses", "erin@laureladulted.org", CORBIN_PHONE, "b3"),
    ...
    new Course(Tiers.I, Subjects.M, "#04", "Wednesday", "2:30-3:15", IM_Folder, CORBIN_ZOOM, `${IM_Overview}${NOTE_START}No classes week of 6/1${NOTE_END}`, "img/erinm.webp", "Erin Moses", "erin@laureladulted.org", CORBIN_PHONE, "c7"),
...
const rlaCourses = [
    ...
    new Course(Tiers.I, Subjects.R, "#04", "Wednesday", "4:45-5:30", IR_Folder, LONDON_ZOOM, `${IR_Overview}`, "img/rachaelc_v2.webp", "Chestnut/Hacker", "rachael@laureladulted.org", LONDON_PHONE, "c10"),
...
const soc_SciCourses = [
    ...
    new Course(Tiers.I, Subjects.S, "#04", "Wednesday", "10:30-11:15", IS_Folder, CLAY_ZOOM, `${IS_Overview}${NOTE_START}No class 6/3${NOTE_END}`, "img/ryanc.webp", "Ryan Cornett", "ryan@laureladulted.org", CLAY_PHONE, "c3"),
    ...
    new Course(Tiers.I, Subjects.S, "#05", "Thursday", "10:30-11:15", IS_Folder, CLAY_ZOOM, `${IS_Overview}${NOTE_START}No class 6/4${NOTE_END}`, "img/ryanc.webp", "Ryan Cornett", "ryan@laureladulted.org", CLAY_PHONE, "d3"),
];
